...
function App() {
  ...
  return (
    <AnimateProvider className="flex flex-col text-sm md:mx-auto md:max-w-xl bg-neutral-100 p-8 mt-4 border rounded">
      <h1 className="text-lg font-bold text-violet-700 mb-10 text-center">
      ...
      <button
        className="flex rounded-full bg-violet-600 p-1 py-2 md:py-2 justify-center font-semibold md:font-bold text-sm md:text-base text-center hover:bg-violet-800 transition text-white"
        onClick={handleBegin}
      >
        Take Quiz
      </button>
